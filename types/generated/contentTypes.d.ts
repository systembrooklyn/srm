...
export interface ApiMAppCourseMAppCourse extends Schema.CollectionType {
  collectionName: 'm_app_courses';
  info: {
    singularName: 'm-app-course';
    pluralName: 'm-app-courses';
    displayName: 'mAppCourse';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    g9_date: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g10: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g10_date: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g11: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g11_date: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g12: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g12_date: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g1_att: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g2_att: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g3_att: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g4_att: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g5_att: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g6_att: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g7_att: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g8_att: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g9_att: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g10_att: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g11_att: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g12_att: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g1_total_lec: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g2_total_lec: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g3_total_lec: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g4_total_lec: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g5_total_lec: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g6_total_lec: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g7_total_lec: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g8_total_lec: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g9_total_lec: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g10_total_lec: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g11_total_lec: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g12_total_lec: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g1_grade: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g2_grade: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g3_grade: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g4_grade: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g5_grade: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g6_grade: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g7_grade: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g8_grade: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g9_grade: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g10_grade: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g11_grade: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g12_grade: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g1_name: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g2_name: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g3_name: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g4_name: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g5_name: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g6_name: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g7_name: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g8_name: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g9_name: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g10_name: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g11_name: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    g12_name: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    createdAt: Attribute.DateTime;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::m-app-course.m-app-course': ApiMAppCourseMAppCourse;
